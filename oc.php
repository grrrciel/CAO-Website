...
<head>
  ...
  <link rel="icon" type="image/png" href="img/last.png">
  ...
  <style>
    ...
    .oc-image {
      ...
      height: auto;
      border-radius: 8px;
      box-shadow: 0 0 20px rgba(0, 150, 57, 0.3);
    }
...
<body>
  ...
  <!-- Image Section Immediately After Header -->
  <section class="oc">
    <img src="img/about/oc.png" alt="Organizational Chart" class="oc-image">
  </section>
  ...
  <footer class="footer spad set-bg" data-setbg="img/footer-bg.png" style="text-align: center;">
    <div class="container">
      ...
      <div class="footer__copyright__text" style="margin-top: 10px;">
