...
<div class="banner">
    <video autoplay loop muted playsinline>
        <source src="img/tanglaw/mv.mp4" type="video/mp4">
    </video>
<!-- BG Section End -->
                    ...
                    <div id="eventCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img src="img/tanglaw/t.png" alt="Featured Event 1" class="d-block w-100 img-fluid" style="width: 100%; height: auto; margin-bottom: 30px; border-radius: 10px;">
                            </div>
                    </div>
                </div>
            </div>
...
<div class="gallery-container">
    <!-- 3D Rotating Gallery -->
    <div class="gallery">
        <span style="--i:1"><img src="img/tanglaw/9.png" alt=""></span>
        <span style="--i:2"><img src="img/tanglaw/13.png" alt=""></span>
        <span style="--i:3"><img src="img/tanglaw/21.png" alt=""></span>
        <span style="--i:4"><img src="img/tanglaw/14.png" alt=""></span>
        <span style="--i:5"><img src="img/tanglaw/22.png" alt=""></span>
        <span style="--i:6"><img src="img/tanglaw/23.png" alt=""></span>
        <span style="--i:7"><img src="img/tanglaw/24.png" alt=""></span>
        <span style="--i:8"><img src="img/tanglaw/14.png" alt=""></span>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/tanglaw/v1.jpg">
                                <a href="https://www.facebook.com/clsupigura/videos/1272742624631472" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div> 
                            <div class="youtube__item__text">
                                <h4>CAASUC III 2024 - Alingawngaw ng Gutom</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/tanglaw/v2.png">
                                <a href="https://www.facebook.com/watch/?v=985291689758629" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>                  
                            <div class="youtube__item__text">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/tanglaw/v3.jpg">
                                <a href="https://www.facebook.com/watch/?v=1083055809968318" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>   
                            <div class="youtube__item__text">
