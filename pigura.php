...
<div class="banner">
    <video autoplay loop muted playsinline>
        <source src="img/pigura/mv.mp4" type="video/mp4">
    </video>
<!-- BG Section End -->
                    ...
                    <div id="eventCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img src="img/pigura/p.png" alt="Featured Event 1" class="d-block w-100 img-fluid" style="width: 100%; height: auto; margin-bottom: 30px; border-radius: 10px;">
                            </div>
                    </div>
                </div>
            </div>
...
<div class="gallery-container">
    <!-- 3D Rotating Gallery -->
    <div class="gallery">
        <span style="--i:1"><img src="img/pigura/7.png" alt=""></span>
        <span style="--i:2"><img src="img/pigura/10.png" alt=""></span>
        <span style="--i:3"><img src="img/pigura/16.png" alt=""></span>
        <span style="--i:4"><img src="img/pigura/11.png" alt=""></span>
        <span style="--i:5"><img src="img/pigura/17.png" alt=""></span>
        <span style="--i:6"><img src="img/pigura/18.png" alt=""></span>
        <span style="--i:7"><img src="img/pigura/19.png" alt=""></span>
        <span style="--i:8"><img src="img/pigura/11.png" alt=""></span>
    </div>
</div>
...
<br><br><br><br><br><br><br><br><br>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/pigura/v1.png">
                                <a href="https://www.facebook.com/clsupigura/videos/1272742624631472" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div> 
                            <div class="youtube__item__text">
                                <h4>Pagsulong ng Sining, Mula sa Diwa at Damdamin</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/pigura/v3.png">
                                <a href="https://www.facebook.com/reel/658991053131641" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>                  
                            <div class="youtube__item__text">
                                <h4>Ani ng Sining, Diwa at Damdamin</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/pigura/v2.png">
                                <a href="https://www.facebook.com/clsupigura/videos/1656038078531230" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>   
                            <div class="youtube__item__text">
        ...
        <!-- Youtube Section End --><!-- Footer Section Begin --><br>
