...
<div class="banner">
    <video autoplay loop muted playsinline>
        <source src="img/bithay/mv.mp4" type="video/mp4">
    </video>
<!-- BG Section End -->
                ...
                <div id="eventCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="img/bithay/b.png" alt="Featured Event 1" class="d-block w-100 img-fluid" style="width: 100%; height: auto; margin-bottom: 30px; border-radius: 10px;">
                        </div>
                </div>
            </div>
        </div>
...
<div class="gallery-container">
    <!-- 3D Rotating Gallery -->
    <div class="gallery">
        <span style="--i:1"><img src="img/bithay/3.png" alt=""></span>
        <span style="--i:2"><img src="img/bithay/5.png" alt=""></span>
        <span style="--i:3"><img src="img/bithay/6.png" alt=""></span>
        <span style="--i:4"><img src="img/bithay/4.png" alt=""></span>
        <span style="--i:5"><img src="img/bithay/7.png" alt=""></span>
        <span style="--i:6"><img src="img/bithay/9.png" alt=""></span>
        <span style="--i:7"><img src="img/bithay/8.png" alt=""></span>
        <span style="--i:8"><img src="img/bithay/4.png" alt=""></span>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/bithay/v1.png">
                                <a href="https://www.facebook.com/dninaricci/videos/514214313958940" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div> 
                            <div class="youtube__item__text">
                                <h4>CLSU Bithay Sining Dance Company Pop at CAASUC 2022</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/bithay/v3.jpg">
                                <a href="https://www.facebook.com/watch/?ref=search&v=835642828622653&external_log_id=dd1d3446-59f5-48f7-b7da-39aec8f94b26&q=bithay%20rondalla" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>                  
                            <div class="youtube__item__text">
                                <h4>CLSU Bithay Sining Dance Company and Rondalla</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/bithay/v2.png">
                                <a href="https://www.facebook.com/watch/?v=2038081699995949" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>                  
                            <div class="youtube__item__text">
                                <h4>CAASUC III - 2024 Folk Dance Category - Sala Ti Mais</h4>
                            </div>
                        </div>
                    </div>
                </div>
