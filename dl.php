...
<br><br><br><br><br>
<div class="content">
    <h3 style="text-align: center;">DOWNLOADABLES</h3>
</div>

<div class="download-section">
    <div class="download-item">
        <a href="https://example.com/download1" target="_blank">
            <img src="img/about/rf.jpg" alt="Download 1">
            <h4>Performance Request Form</h4>
        </a>
    </div>
    <div class="download-item">
        <a href="https://example.com/download2" target="_blank">
            <img src="img/about/ff.jpg" alt="Download 2">
            <h4>Feedback Form</h4>
        </a>
    </div>
</div>
