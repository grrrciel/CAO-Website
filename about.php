...
<div class="header__logos">
    ...
    <br><br>
                ...
                <div class="row">
                    <div class="col-lg-6 order-lg-1">
                        <div class="tours__item__text">
                            ...
                            <div class="tours__text__desc"><br>
                                <h3>MISSION</h><br>
                                    <p><br>CLSU shall develop globally competitive, work-ready, socially-responsible and empowered human resources who value life long learning; and to generate, disseminate, and apply knowledge and technologies for poverty alleviation, environmental protection and sustainable development.</p>
                    ...
                    <div class="col-lg-6 order-lg-4">
                        <div class="tours__item__text tours__item__text--right">
                            ...
                            <div class="tours__text__desc"><br>
                                <h3>VISION</h><br>
                                    <p><br>CLSU as a world-class National Research University for science and technology in angriculture and allied fields.</p>
                                                </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 order-lg-5">
                        <div class="tours__item__text">
                            <div class="tours__text__widget">
                                <h3>PHILOSOPHY</h><br>
                                    <p><br>The ultimate measure of the effectiveness of Central Luzon State University as an institution of higher learning is its contribution to and impact on the educational, economic, social, cultural, political, and moral well-beng and environmental consciousness of the people it serves.</p>
                                                </div>
                        </div>
                        </div>
                    </div>
        ...
        <!-- Tours Section End --><!-- Footer Section Begin --><br>
