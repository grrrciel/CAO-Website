...
<div class="banner">
    <video autoplay loop muted playsinline>
        <source src="img/band/mv.mp4" type="video/mp4">
    </video>
<!-- BG Section End -->
                ...
                <div id="eventCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img src="img/band/b.png" alt="Featured Event 1" class="d-block w-100 img-fluid" style="width: 100%; height: auto; margin-bottom: 30px; border-radius: 10px;">
                        </div>
                </div>
            </div>
        </div>
...
<div class="gallery-container">
    <!-- 3D Rotating Gallery -->
    <div class="gallery">
        <span style="--i:1"><img src="img/band/5.png" alt=""></span>
        <span style="--i:2"><img src="img/band/7.png" alt=""></span>
        <span style="--i:3"><img src="img/band/8.png" alt=""></span>
        <span style="--i:4"><img src="img/band/11.png" alt=""></span>
        <span style="--i:5"><img src="img/band/12.png" alt=""></span>
        <span style="--i:6"><img src="img/band/13.png" alt=""></span>
        <span style="--i:7"><img src="img/band/14.png" alt=""></span>
        <span style="--i:8"><img src="img/band/11.png" alt=""></span>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/band/v1.jpg">
                                <a href="https://www.facebook.com/clsubandofficial/videos/616605750994392" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div> 
                            <div class="youtube__item__text">
                                <h4>Samot-Sari CLSU Band Performance</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/band/v2.jpg">
                                <a href="https://www.facebook.com/clsubandofficial/videos/967270082121925" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>                  
                            <div class="youtube__item__text">
                                <h4>Christmas Band Caroling</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="youtube__item">
                            <div class="youtube__item__pic set-bg" data-setbg="img/band/v3.jpg">
                                <a href="https://www.facebook.com/clsubandofficial/videos/817447333847467" target="_blank" class="play-btn">
                                    <i class="fa fa-play"></i>
                                </a>
                            </div>   
                            <div class="youtube__item__text">
                                <h4>CLSU Band @ Sikad 2024</h4>
                            </div>
                        </div>
                    </div>
                </div>
